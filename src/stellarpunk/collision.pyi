...
class RocketModel:
    def __init__(self, rocket_space:RocketSpace, body:cymunk.Body, i_sp:float=0.0, max_thrust:float=0.0, max_fine_thrust:float=0.0, max_torque:float=0.0) -> None: ...
    ...
    def get_force(self) -> cymunk.Vec2d: ...
