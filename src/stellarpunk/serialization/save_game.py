...
class SectorEntitySaver[SectorEntity: core.SectorEntity](EntitySaver[SectorEntity], abc.ABC):
    ...
    @abc.abstractmethod
    def _load_sector_entity(self, f:io.IOBase, load_context:LoadContext, entity_id:uuid.UUID, loc:npt.NDArray[np.float64], phys_body:cymunk.Body, sensor_settings:core.AbstractSensorSettings) -> tuple[SectorEntity, Any]: ...

    def _post_load_sector_entity(self, sector_entity:SectorEntity, load_context:LoadContext, extra_context:Any) -> None:
    ...
    def post_load(self, sector_entity:SectorEntity, load_context:LoadContext, context:Any) -> None:
