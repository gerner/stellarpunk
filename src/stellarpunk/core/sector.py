...
class AbstractSensorManager:
    ...
    @abc.abstractmethod
    def spatial_query(self, detector:SectorEntity, bbox:Tuple[float, float, float, float]) -> Iterator[AbstractSensorImage]: ...

    @abc.abstractmethod
    def spatial_point(self, detector:SectorEntity, point:Union[Tuple[float, float], npt.NDArray[np.float64]], max_dist:Optional[float]=None) -> Iterator[AbstractSensorImage]: ...
