...
build/build_flag: $(SOURCES)
	...
	python setup.py build_ext --inplace 2> >(gawk '@load "filefuncs"; {match($$0, "build/(src/stellarpunk/[^:]+):", m); if(stat(m[1], fstat) == 0) { sub("build/src/stellarpunk/", "src/stellarpunk/")} print $$0}' 1>&2)
